...
SpeedController::SpeedController() :
  _LeftPID(&_LeftSpeed, &_LeftMotor, &_ReqLeftSpeed, 0, 0, 0, DIRECT)
{
...
{
  // Set Direction
  _RightDirection == FORWARD ? analogWrite(RIGHT_DIRECTION_PIN, HIGH) : analogWrite(RIGHT_DIRECTION_PIN, LOW);
...
{
  // Set Direction
  _LeftDirection == FORWARD ? analogWrite(LEFT_DIRECTION_PIN, HIGH) : analogWrite(LEFT_DIRECTION_PIN, LOW);
